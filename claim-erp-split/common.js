...
const CLAIMS = [
  ...
  { id:"CLM-2026-0001", name:"김민수", car:"12하3456", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"계약조사", status:"계약정보 확인", urgency:"주의", elapsed:"6시간 20분", manager:"박지현", procStatus:"미처리",
  ...
  { id:"CLM-2026-0002", name:"이서연", car:"34허7821", custType:"리스",
    flowStage:"접수·선견적", actionType:"계약조사", status:"이전 접수이력 확인", urgency:"정상", elapsed:"2시간 15분", manager:"최도윤", procStatus:"처리중",
    deductible:"30만원",
  ...
  { id:"CLM-2026-0013", name:"조민혁", car:"47너8253", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"면허미확인", status:"운전자 정보 확인", urgency:"정상", elapsed:"2시간 45분", manager:"박지현", procStatus:"미처리",
    deductible:"50만원",
    actionDesc:"운전자 면허번호 입력 요청 후 미응답",
    nextAction:"고객에게 정보 입력 링크를 재발송하세요." },
  { id:"CLM-2026-0014", name:"서지우", car:"31두5147", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"면허미확인", status:"사고정보 확인", urgency:"주의", elapsed:"5시간 10분", manager:"최도윤", procStatus:"처리중",
    deductible:"손해액의 20% / 20~50만원",
    actionDesc:"사고경위 확인 요청 후 미응답",
    nextAction:"고객 전화로 사고경위를 직접 확인하세요." },
  { id:"CLM-2026-0015", name:"황민서", car:"62루1428", custType:"리스",
    flowStage:"접수·선견적", actionType:"계약조사", status:"계약정보 확인", urgency:"정상", elapsed:"1시간 50분", manager:"박지현", procStatus:"미처리",
    deductible:"30만원",
    actionDesc:"계약자/운전자 관계 확인이 필요함",
    nextAction:"계약조건의 운전자 범위를 확인하세요." },
  { id:"CLM-2026-0016", name:"노아인", car:"19모7765", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"계약조사", status:"이전 접수이력 확인", urgency:"정상", elapsed:"3시간", manager:"김하늘", procStatus:"미처리",
    deductible:"50만원",
  ...
  { id:"CLM-2026-0017", name:"류현빈", car:"84버3391", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"VOC", status:"사고정보 확인", urgency:"정상", elapsed:"1시간 20분", manager:"문태호", procStatus:"미처리",
    deductible:"손해액의 20% / 20~50만원",
    actionDesc:"고객이 접수 진행상황 문의로 연락을 요청함",
    nextAction:"고객에게 접수 진행상황을 안내하세요." },
  { id:"CLM-2026-0018", name:"김다온", car:"53소2284", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"면허미확인", status:"운전자 정보 확인", urgency:"정상", elapsed:"40분", manager:"박지현", procStatus:"미처리",
    deductible:"30만원",
    actionDesc:"운전자 인적사항 입력 대기 중",
    nextAction:"미응답 지속 시 정보요청 알림을 재발송하세요." },
  { id:"CLM-2026-0019", name:"박서윤", car:"26우6512", custType:"리스",
    flowStage:"접수·선견적", actionType:"계약조사", status:"계약정보 확인", urgency:"정상", elapsed:"2시간 05분", manager:"최도윤", procStatus:"처리중",
    deductible:"50만원",
  ...
  { id:"CLM-2026-0003", name:"정우진", car:"56호9012", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"선견적 자료 대기", urgency:"정상", elapsed:"4시간 40분", manager:"김하늘", procStatus:"미처리",
    actionDesc:"파손부위 근접사진과 차량 전체사진이 미등록됨",
    nextAction:"사진 요청 알림을 재발송하세요." },
  { id:"CLM-2026-0004", name:"박지훈", car:"78바1123", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"AOS 선견적 수신 대기", urgency:"주의", elapsed:"7시간 10분", manager:"오세린", procStatus:"미처리",
    actionDesc:"공업사에 AOS 선견적 요청 후 미회신",
    nextAction:"공업사에 선견적 등록을 재요청하세요." },
  { id:"CLM-2026-0012", name:"남기준", car:"33호1212", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"VOC", status:"입고지 확인", urgency:"긴급", elapsed:"35분", manager:"문태호", procStatus:"미처리",
  ...
  { id:"CLM-2026-0020", name:"이준호", car:"71자9034", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"선견적 자료 대기", urgency:"정상", elapsed:"3시간 05분", manager:"김하늘", procStatus:"미처리",
    actionDesc:"차량 전체사진이 미등록됨",
    nextAction:"사진 요청 알림을 재발송하세요." },
  { id:"CLM-2026-0021", name:"정하람", car:"38조4470", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"AOS 선견적 수신 대기", urgency:"주의", elapsed:"6시간 40분", manager:"오세린", procStatus:"미처리",
    actionDesc:"공업사 AOS 선견적 등록이 지연되고 있음",
    nextAction:"공업사에 선견적 등록을 재요청하세요." },
  { id:"CLM-2026-0022", name:"최서아", car:"95고1182", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"선견적 자료 대기", urgency:"주의", elapsed:"8시간 10분", manager:"김하늘", procStatus:"미처리",
    actionDesc:"파손부위 근접사진 미등록으로 선견적 검토가 불가함",
    nextAction:"고객 전화로 사진 등록 방법을 안내하세요." },
  { id:"CLM-2026-0023", name:"강시우", car:"14노5521", custType:"리스",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"입고지 확인", urgency:"정상", elapsed:"2시간 30분", manager:"문태호", procStatus:"처리중",
    actionDesc:"입고 예정 공업사가 미확정 상태임",
    nextAction:"고객과 입고지 협의 후 공업사를 확정하세요." },
  { id:"CLM-2026-0024", name:"윤지호", car:"58도8810", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"AOS 선견적 수신 대기", urgency:"정상", elapsed:"1시간 35분", manager:"오세린", procStatus:"미처리",
    actionDesc:"공업사에 선견적 요청 후 회신 대기 중",
    nextAction:"회신기한 경과 시 공업사에 재요청하세요." },
  { id:"CLM-2026-0025", name:"임채원", car:"42로3356", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"입고지 확인", urgency:"주의", elapsed:"5시간 25분", manager:"박지현", procStatus:"미처리",
    actionDesc:"입고 일정 안내 후 고객 미응답",
    nextAction:"고객에게 입고 일정 확인을 재요청하세요." },
  { id:"CLM-2026-0026", name:"한지안", car:"77보6643", custType:"리스",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"입고 확인 대기", urgency:"정상", elapsed:"4시간", manager:"문태호", procStatus:"미처리",
    actionDesc:"공업사 입고 예정시간 경과 후 입고확인 미회신",
    nextAction:"공업사에 입고 여부를 확인하세요." },
  { id:"CLM-2026-0027", name:"오도현", car:"29수9917", custType:"렌터카",
    flowStage:"접수·선견적", actionType:"선견미징구", status:"선견적 자료 대기", urgency:"정상", elapsed:"1시간 10분", manager:"김하늘", procStatus:"미처리",
    actionDesc:"번호판 사진이 미등록됨",
    nextAction:"사진 요청 알림을 발송하세요." },

  /* ---- 3. 수리 승인 ---- */
  { id:"CLM-2026-0005", name:"한유나", car:"90하4455", custType:"리스",
    flowStage:"수리 승인", actionType:"검토미회신", status:"수리 승인 대기", urgency:"긴급", elapsed:"1일 3시간", manager:"문태호", procStatus:"미처리",
  ...
  { id:"CLM-2026-0006", name:"강도현", car:"23허6789", custType:"렌터카",
    flowStage:"수리 승인", actionType:"일보미입력", status:"공업사 수리 오더 대기", urgency:"주의", elapsed:"5시간 30분", manager:"유나래", procStatus:"처리중",
    actionDesc:"공업사 수리 오더 전달 후 진행상태 미회신",
    nextAction:"공업사에 수리 오더 확인을 요청하세요." },
  { id:"CLM-2026-0028", name:"신유진", car:"66어2208", custType:"리스",
    flowStage:"수리 승인", actionType:"검토미회신", status:"수리 승인 대기", urgency:"긴급", elapsed:"1일 6시간", manager:"문태호", procStatus:"미처리",
  ...
  { id:"CLM-2026-0029", name:"백승호", car:"81저7745", custType:"렌터카",
    flowStage:"수리 승인", actionType:"일보미입력", status:"공업사 수리 오더 대기", urgency:"주의", elapsed:"7시간 20분", manager:"유나래", procStatus:"미처리",
    actionDesc:"수리 오더 전달 후 공업사 확인 미회신",
    nextAction:"공업사에 수리 오더 확인을 요청하세요." },
  { id:"CLM-2026-0030", name:"장하늘", car:"36처4419", custType:"렌터카",
    flowStage:"수리 승인", actionType:"VOC", status:"수리 진행상태 확인", urgency:"정상", elapsed:"1시간 45분", manager:"문태호", procStatus:"미처리",
    actionDesc:"고객이 수리 진행상황 문의로 연락을 요청함",
    nextAction:"고객에게 수리 진행상태를 안내하세요." },
  { id:"CLM-2026-0031", name:"송민재", car:"92카8873", custType:"리스",
    flowStage:"수리 승인", actionType:"일보미입력", status:"승인 후 진행 확인", urgency:"정상", elapsed:"3시간 30분", manager:"유나래", procStatus:"처리중",
    actionDesc:"수리 승인 후 공업사 착수 보고 대기 중",
    nextAction:"공업사 착수 여부를 확인하세요." },
  { id:"CLM-2026-0032", name:"안소율", car:"15타3160", custType:"렌터카",
    flowStage:"수리 승인", actionType:"일보미입력", status:"공업사 수리 오더 대기", urgency:"정상", elapsed:"2시간 15분", manager:"유나래", procStatus:"보류",
    actionDesc:"부품 수급 확인 후 오더 예정으로 보류 중",
    nextAction:"부품 수급 확정 시 수리 오더를 전달하세요." },

  /* ---- 4. 손해사정 ---- */
  { id:"CLM-2026-0007", name:"배수빈", car:"45하2233", custType:"렌터카",
    flowStage:"손해사정", actionType:"청구미수신", status:"AOS 청구 수신 대기", urgency:"주의", elapsed:"9시간 30분", manager:"박지현", procStatus:"미처리",
    actionDesc:"공업사 AOS 청구서 수신이 지연되고 있음",
    nextAction:"공업사에 AOS 청구 등록을 요청하세요." },
  { id:"CLM-2026-0008", name:"윤태준", car:"67호8844", custType:"리스",
    flowStage:"손해사정", actionType:"계약조사", status:"면부책 및 과실 확인", urgency:"긴급", elapsed:"1일 2시간", manager:"최도윤", procStatus:"미처리",
  ...
  { id:"CLM-2026-0033", name:"권나윤", car:"64파5528", custType:"렌터카",
    flowStage:"손해사정", actionType:"청구미수신", status:"AOS 청구 수신 대기", urgency:"정상", elapsed:"3시간 40분", manager:"박지현", procStatus:"미처리",
    actionDesc:"공업사 AOS 청구서 수신 대기 중",
    nextAction:"회신기한 경과 시 청구 등록을 재요청하세요." },
  { id:"CLM-2026-0034", name:"홍서준", car:"73거2917", custType:"리스",
    flowStage:"손해사정", actionType:"손해사정완료", status:"손해사정 진행", urgency:"정상", elapsed:"5시간", manager:"최도윤", procStatus:"처리중",
    actionDesc:"수리비 적정성 검토가 진행 중임",
    nextAction:"AOS 청구 내역과 선견적을 대조 검토하세요." },
  { id:"CLM-2026-0035", name:"문가은", car:"28너4631", custType:"렌터카",
    flowStage:"손해사정", actionType:"계약조사", status:"면부책 및 과실 확인", urgency:"정상", elapsed:"2시간 50분", manager:"최도윤", procStatus:"미처리",
    actionDesc:"과실비율 협의 결과 반영이 필요함",
    nextAction:"보험사 과실 협의 결과를 확인해 반영하세요." },
  { id:"CLM-2026-0036", name:"양현우", car:"51더7384", custType:"렌터카",
    flowStage:"손해사정", actionType:"청구미수신", status:"AOS 청구 수신 대기", urgency:"정상", elapsed:"1시간 25분", manager:"박지현", procStatus:"미처리",
...
["CLM-2026-0032", "CLM-2026-0029"].forEach(id => {
  ...
  if (c) { c.actionType = "청구미수신"; c.reviewState = "검토요청"; }
});
...
const VIEW_TITLES = { claims:"미결일괄조회", intake:"Smart업무처리", images:"이미지 시스템", closing:"결재 LIST", assign:"전결관리", rotation:"순환배당관리", vendor:"협력업체조회", ai:"AI 통합대시보드" };
const VIEW_FILES = {
  ...
  rotation: "rotation-assignment.html",
  vendor: "vendor-inquiry.html",
