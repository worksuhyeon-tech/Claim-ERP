...
const REP_TEMPLATES = [
  { id: "R1", cat: "운전자확인", title: "운전면허 확인 안내",
    content: "[SK렌터카] #{고객명}님, 사고건(#{사고접수번호}) 처리를 위해 운전면허 확인이 필요합니다. 운전면허증 사본 제출을 부탁드립니다.\n담당 #{담당자명} #{담당자연락처}", code: "SKR_LICENSE_CHECK_01" },
  { id: "R2", cat: "사고처리진행안내", title: "임직원 확인 서류 제출 안내",
    content: "[SK렌터카] #{고객명}님, 임직원(직원/대표) 확인을 위한 서류 제출이 필요합니다. 재직증명서 등 확인 서류를 제출해 주세요.\n담당 #{담당자명} #{담당자연락처}", code: "SKR_EMPLOYEE_DOC_01" },
  { id: "R3", cat: "가족관계서류", title: "가족관계확인서류 제출 안내",
    content: "[SK렌터카] #{고객명}님, 사고건(#{사고접수번호}) 처리를 위해 가족관계확인서류 제출이 필요합니다.\n담당 #{담당자명}", code: "SKR_FAMILY_DOC_01" },
  { id: "R4", cat: "담당자안내", title: "담당자 지정 및 변경 안내",
    content: "[SK렌터카] #{고객명}님, 사고건(#{사고접수번호}) 담당자가 지정/변경되었습니다. 담당 #{담당자명}(#{담당자연락처})가 안내드리겠습니다.", code: "SKR_MANAGER_ASSIGN_01" },
  { id: "R5", cat: "개인정보동의", title: "개인정보동의 안내",
    content: "[SK렌터카] #{고객명}님, 사고 처리를 위한 개인정보 수집·이용 동의가 필요합니다. 안내에 따라 동의를 완료해 주세요.\n담당 #{담당자명} #{담당자연락처}", code: "SKR_PRIVACY_CONSENT_01" },
];
...
const STD_SEED = [
  ...
  { id: "S2", seq: 2, regAt: "2026-05-07 18:21", person: "대물", eventKey: "대물입고안내", consultType: "입고지원", sendType: "입고안내", msgType: "物입고안내", title: "대물입고안내(피보)", regBy: "김수현",
    content: "[SK렌터카] #{고객명}님, 피보험차량(#{차량번호}) 입고 안내입니다. #{정비업체명}에서 수리 진행 예정입니다.\n담당 #{담당자명} #{담당자연락처}" },
  { id: "S3", seq: 3, regAt: "2023-09-13 09:27", person: "대물", eventKey: "서류요청", consultType: "서류안내", sendType: "서류요청", msgType: "기타", title: "사업자등록여부", regBy: "김수현",
    content: "[SK렌터카] #{고객명}님, 부가세 환급 처리를 위해 사업자등록 여부 확인이 필요합니다. 회신 부탁드립니다.\n담당 #{담당자명}" },
  { id: "S4", seq: 4, regAt: "2026-03-02 11:02", person: "대물", eventKey: "렌트안내", consultType: "렌트지원", sendType: "설치안내", msgType: "기타", title: "렌트모바일시스템 설치안내", regBy: "김수현",
...
function openStdSettings() {
  ...
  const blankStd = () => ({ id: "S" + Date.now(), seq: list.reduce((m, x) => Math.max(m, x.seq || 0), 0) + 1, regAt: nowStr(), person: "대물", eventKey: "", consultType: "입고지원", sendType: "", msgType: "기타", title: "", content: "", regBy: "김수현" });
